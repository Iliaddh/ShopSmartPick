...
function Card({img, price, content,title, link }) {
  ...
  return (
      <div className='items-center  border-2 border-gray-200 shadow-lg rounded p-4 mt-6  h-full '>
        ...
        <div className=' mt-20  flex justify-center'><button className=' b-0 p-2 w-3/5 h-10 rounded-lg bg-gray-400 text-white  mb-0 '><a href={link} target="_blank">Visit Website</a></button></div>
